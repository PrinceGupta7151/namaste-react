...
const Body = () => {
  ...
  const fetchData = async()=>{
    const data = await fetch(
      "https://www.swiggy.com/dapi/restaurants/list/v5?lat=29.86370&lng=77.88350&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
    );
  ...
  if(onlineStatus === false)
    return (
  <h1>
    Looks like you're Offline . Check your Internet Connnection !!
  </h1>
  );
